<div class="x_panel" alignt="center">
    <div class="x_content">
        <div class="col-sm-3 col-md-3">
            <div class="thumbnail" style="height: auto; position: relative; left: 100%; width: 200%">
                ...
                <div class="caption">
                    <h5 style="min-height: 40px;" alignt="center"><?= $pengarang ?></h5>
                    <center>
                    ...
                    <p>
                        <a class="btn btn-outline-primary fas fw fa-shopping-card" href="<?= base_url('booking/tambahBooking/' . $id); ?>">Booking</a>
