            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <?php } else { ?>
                        ...
                        <a class="nav-item nav-link" data-toggle="modal" data-target="#loginModal" href=""><i class="fas fw fa-sign-in-alt"></i> Log in</a>
                    <?php } ?>
                    <span class="nav-item nav-right" style="display: block; margin-left:20px;">Selamat Datang <b><?= $user; ?></b></span>
                </div>
            </div>
        </div>
    </nav>
